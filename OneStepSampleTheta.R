...
#' 
#' @param Y An 'N x 1' list of 'n x 1' vectors denoting the features of a single observation.
#' @param V An 'N x 1' list of Observed fisher information matrices
#' @param mu An 'N x 1' list of n x 1' vectors denoting the prior means.
#' @param Sigma An 'N x 1' vector of 'n x n' matrices denoting the prior variances for each cluster.
#' @return An N 'n x 1' vectors that is sampled from mixture normal random effects model.
